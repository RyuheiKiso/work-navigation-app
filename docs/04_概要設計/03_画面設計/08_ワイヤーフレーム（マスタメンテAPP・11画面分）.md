...
図: `fig_des_screen_ma_001.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_002.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_003.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_004.{drawio,svg}`（img/ 配下）を参照。
...
| **中央ペイン: 編集フォーム** | **flex（残余の 2/3）** | flex（独立スクロール）| Step 属性フォーム + セグメントナビ（DSL / 履歴 / コメント）|
...
図: `fig_des_screen_ma_005.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_006.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_007.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_008.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_009.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_010.{drawio,svg}`（img/ 配下）を参照。
...
図: `fig_des_screen_ma_011.{drawio,svg}`（img/ 配下）を参照。
