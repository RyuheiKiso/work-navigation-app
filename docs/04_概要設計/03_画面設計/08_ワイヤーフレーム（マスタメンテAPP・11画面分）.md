...
| **左ペイン: SOP ツリー** | **280px 固定** | flex | `CMP-MA-001 SopTreeEditor` |
...
| ペイン境界 | 1px | flex | `FRG-026 Divider vertical` |
...
|---|---|---|---|---|
| CMP-MA-001 | SopTreeEditor | 280 × flex | `surface.subtle` / `shadow.1` 右側 | idle / drag / selected |
...
- **MA-004 の 3 ペイン（ツリー 280px 固定 / フォーム flex / 差分 360px 固定）とドラッグハンドル・セグメントナビ（DSL/履歴/コメント）の再設計を確定した。**
