...
図: `fig_des_screen_mc_001.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_002.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_003.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_004.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_005.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_006.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_007.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_008.{drawio,svg}`（img/ 配下・新規）を参照。
...
図: `fig_des_screen_mc_009.{drawio,svg}`（img/ 配下・新規）を参照。
