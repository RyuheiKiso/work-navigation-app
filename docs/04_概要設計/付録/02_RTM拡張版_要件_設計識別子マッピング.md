...
| BR-BUS-020 | カスタム Step タイプ定義（拡張 Step エンジン）| FR-NV-006 | Should | SCR-MA-004/SCR-HA-007 | API-master-003 | TBL-029 |
...
| BR-SC-003 | シナリオ: マスタ改訂 | FR-MA-001〜015 | Must | SCR-MA-001〜011 | API-master-001〜010 | TBL-004/007/008 |
