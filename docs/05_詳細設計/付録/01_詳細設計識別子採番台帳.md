...
| 区分 | 採番先 | 採番済み範囲 | 次採番値 |
|---|---|---|---|
| FNC-BE | 02_バックエンド詳細設計 各章 | FNC-BE-001〜017 | FNC-BE-018 |
| FNC-FE | 04_ハンディAPP詳細設計 各章 | FNC-FE-001〜016 | FNC-FE-017 |

---

**本節で確定した方針**
- **IDX-001〜018（次採番値 IDX-019）・VW-001〜008（次採番値 VW-009）を 05_詳細設計 で正式採番し、04_概要設計/付録/99_設計識別子採番台帳.md の「未採番」状態を解消した。**
