-- V20260519120006__create_views.sql
-- VW-001〜008 全ビュー・マテリアライズドビューの作成
-- ビューは読み取り専用とし、ビューを通じた INSERT/UPDATE は行わない
-- =====================================================
...
-- =====================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_daily_work_summary AS
SELECT
...
-- UNIQUE インデックスにより REFRESH CONCURRENTLY が使用可能
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_daily_work_summary_pk
    ON mv_daily_work_summary (work_date, sop_id);

CREATE INDEX IF NOT EXISTS idx_mv_daily_work_summary_date
