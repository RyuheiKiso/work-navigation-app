...
function createInitialDb(): MockDatabase {
  ...
  return {
    ...
    incomingInspections: [
      {
        id: uuidv7(), lotId, supplierId, materialId,
        receivedQty: 100, samplingPlanId,
        sampleSizeN: 5, acceptNumberAc: 0, rejectNumberRe: 2,
        severityState: 'NORMAL' as const, qcStatus: 'PASSED' as const,
        defectCount: 0, inspectedAt: now, judgedAt: now, judgedBy: qualityAdminId,
        createdAt: now,
      },
      {
        id: uuidv7(), lotId, supplierId, materialId,
        receivedQty: 200, samplingPlanId,
        sampleSizeN: 8, acceptNumberAc: 1, rejectNumberRe: 3,
        severityState: 'NORMAL' as const, qcStatus: 'FAILED' as const,
        defectCount: 2, inspectedAt: now, judgedAt: now, judgedBy: qualityAdminId,
        createdAt: now,
      },
    ],
    ...
    concessionApprovals: [
      {
        id: uuidv7(),
        incomingInspectionId: uuidv7(),
        requestedBy: supervisorId,
        approvedBy: null,
        approvalSign: null,
        electronicSignId: null,
        conditionNote: '外観検査済み・使用可能と判断',
        validityScope: '今回ロットのみ',
    ...
    reworks: [
      {
        ...
        parentCaseId: uuidv7(),
        reworkCaseId: uuidv7(),
        nonconformityId: uuidv7(),
        sopId,
        reworkSopVersionId: sopVersionId,
        assignedTo: operatorId,
    ...
    dispositions: [
      {
        id: uuidv7(),
        nonconformityId: uuidv7(),
        dispositionType: 'REWORK' as const,
        decision: 'REWORK' as const,
        decisionReason: '仕様内での再加工が可能と判断',
        qualityAdminSignId: null,
        supervisorSignId: null,
        signedAt: null,
        createdAt: now,
      },
    ],
